...
export default function Contact({ links, linksSocial, contact, loader }) {
  ...
  const sendEmail = async () => {
                                          ...
                                          <tbody>
                                            <tr>
                                              <td class="esd-block-image" align="center" style="font-size:0">
                                                <a target="_blank">
                                                  <img src="https://tlr.stripocdn.email/content/guids/CABINET_75694a6fc3c4633b3ee8e3c750851c02/images/18501522065897895.png" alt style="display: block;" width="46" />
                                                </a>
                                              </td>
                                            </tr>
                                          </tbody>
                                                ...
                                                <table class="es-menu" width="40%" cellspacing="0" cellpadding="0" align="center">
                                                  <tbody>
                                                    <tr class="links-images-top">
                                                      <td class="es-p10t es-p10b es-p5r es-p5l " style="padding-bottom: 30px; padding-top: 35px; " width="50%" bgcolor="transparent" align="center">
                                                        <a target="_blank" style="color: #ffffff; font-size: 20px;" href>
                                                          <img src="https://tlr.stripocdn.email/content/guids/CABINET_3ef3c4a0538c293f4c84f503cd8af2cc/images/60961522067175378.png" alt title class="es-p5b" height="27" align="absmiddle" />
                                                          <br>
                                                        </a>
                                                      </td>
                                                      <td class="es-p10t es-p10b es-p5r es-p5l " style="padding-bottom: 30px; padding-top: 35px; " width="50%" bgcolor="transparent" align="center">
                                                        <a target="_blank" style="color: #ffffff; font-size: 20px;" href>
                                                          <img src="https://tlr.stripocdn.email/content/guids/CABINET_3ef3c4a0538c293f4c84f503cd8af2cc/images/72681522067183042.png" alt title class="es-p5b" height="27" align="absmiddle" />
                                                          <br>
                                                        </a>
                                                      </td>
                                                    </tr>
    ...
    const raw = JSON.stringify({
      to: 'xibuxcontact@gmail.com',
      from: 'xibuxcontact@gmail.com',
