...
var GlitchPass = function (dt_size) {
  ...
  if (dt_size == undefined) dt_size = 20;
...
GlitchPass.prototype = Object.assign(Object.create(Pass.prototype), {
  ...
  render: function (renderer, writeBuffer, readBuffer) {
    ...
    if (this.curF % this.randX == 0 || this.goWild == true) {
      ...
      this.uniforms["distortion_x"].value = MathUtils.randFloat(0.25, 0.75);
      this.uniforms["distortion_y"].value = MathUtils.randFloat(0.25, 0.75);
      this.curF = 0;
      this.generateTrigger();
      this.curF++;
      ...
      this.uniforms["amount"].value = Math.random() / 30;
      this.uniforms["angle"].value = MathUtils.randFloat(-Math.PI, Math.PI);
      this.uniforms["distortion_x"].value = MathUtils.randFloat(-1, 1);
      this.uniforms["distortion_y"].value = MathUtils.randFloat(-1, 1);
